...
import { OrganizationJsonLd } from '@/components/contacts/OrganizationJsonLd'
...
if (!siteUrl) {
  console.warn('NEXT_PUBLIC_SITE_URL не задан, некоторые SEO-теги будут отсутствовать')
}
...
export default async function ContactsPage() {
  ...
  const { companyName = 'STK', contacts = [], socials = [], workingHours, map } = settings
