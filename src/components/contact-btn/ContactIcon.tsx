...
/** Small "copy to clipboard" glyph used by the copy-fallback button on phone/email items. */
export function CopyGlyph({ sizePx }: { sizePx: number }) {
  return (
    <svg
      width={sizePx}
      height={sizePx}
...
/** Checkmark glyph shown briefly in place of CopyGlyph after a successful copy. */
export function CheckGlyph({ sizePx }: { sizePx: number }) {
  return (
    <svg
      width={sizePx}
      height={sizePx}
