...
export function AboutDirections({ heading, items }: { heading: string; items: AboutDirectionItem[] }) {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 sm:px-6">
      <RevealFx translateY="16" fillWidth trigger={true}>
        <h2 className="mb-8 text-[clamp(1.375rem,2.6vw,1.875rem)] font-bold text-[var(--text-primary)]">{heading}</h2>
      </RevealFx>
